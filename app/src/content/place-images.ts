...
export const PLACE_IMAGES: Record<string, ImageSourcePropType> = {
  ...
  "pmb-city-hall.webp": require("../../assets/places/photos/pmb-city-hall.webp"),
  "naval-hill.webp": require("../../assets/places/photos/naval-hill.webp"),
  "national-womens-memorial.webp": require("../../assets/places/photos/national-womens-memorial.webp"),
  "oliewenhuis-art-museum.webp": require("../../assets/places/photos/oliewenhuis-art-museum.webp"),
  "magaliesberg.webp": require("../../assets/places/photos/magaliesberg.webp"),
  "makhonjwa-mountains.webp": require("../../assets/places/photos/makhonjwa-mountains.webp"),
  "nelson-mandela-museum.webp": require("../../assets/places/photos/nelson-mandela-museum.webp"),
  "qunu.webp": require("../../assets/places/photos/qunu.webp"),
  "emakhosini.webp": require("../../assets/places/photos/emakhosini.webp"),
  "waaihoek-wesleyan-church.webp": require("../../assets/places/photos/waaihoek-wesleyan-church.webp"),
  "pilanesberg-national-park.webp": require("../../assets/places/photos/pilanesberg-national-park.webp"),
};
